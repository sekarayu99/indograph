...
<body style="font-size: 16px">
    <p align="center">
        <span style="font-size: 20px"><b>LAPORAN PENJUALAN <br> CV. INDOGRAPH</b></span> <br>
    </p>
    <hr><br>
    <h5><?= $label;?></h5><br>
    ...
    <p>
        Demikian Laporan Penjualan ini dibuat dengan sebenar-benarnya, untuk diketahui dan digunakan dengan
        semestinya.</p>
    <p>
    <table width="100%">
        <tr>
