...
<div class="row">
    <div class="col-md-2">
        <a href="<?= base_url('pembelian/tambah'); ?>" title="Tambah Pembelian" class="btn btn-success">
            <i class="fa fa-plus"> Transaksi Pembelian</i></a>
    </div>
</div>
<br>
<div class="row">
            ...
            <div class="box-body">
                ...
                foreach ($pembelian->result() as $p) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url('pembelian/edit/' . $p->id); ?>" title="Edit Data"
                                    class="btn btn-warning btn-xs">
                                    <i class="fa fa-pencil"> </i>
                                </a>
                                <a href="<?= base_url('pembelian/hapus/' . $p->id); ?>" title="Hapus Data"
